...
public class HelloWorldProxy implements com.hcl.fault.HelloWorld {
  private String _endpoint = null;
  private com.hcl.fault.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new com.hcl.fault.HelloWorldServiceLocator()).getHelloWorldPort();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public com.hcl.fault.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
